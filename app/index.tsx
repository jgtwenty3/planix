...
export default function Index() {
  ...
  const openLink = async () => {
    WebBrowser.openBrowserAsync('https://github.com/jgtwenty3');
  };
  ...
  return (
    <BottomSheetModalProvider>
      <View style = {[styles.container,{paddingTop:top + 30}]}>
        <Image source={require('@/assets/images/login/planixtext.png')} style={styles.image} />
        <Text style = {styles.introText}>Plan It. Collab It. Do It.</Text>
